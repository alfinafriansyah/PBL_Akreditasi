        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body pt-1 p-3">
                <div class="row">
                    <div class="col">
                        <a href="{{ url('kriteria6/create')}}" class="btn btn-primary float-end me-3">Tambah</a>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="table_kriteria6">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Kode</th>
...
$(document).ready(function() {
    dataKriteria6 = $('#table_kriteria6').DataTable({
        serverSide: true,
        processing: true, 
        ajax: {
