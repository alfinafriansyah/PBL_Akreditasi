        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-footer">
                <a href="{{ url('validasi/kpskajur/' . $kriteria->kriteria_id . '/validate') }}" class="btn btn-success me-2 float-end">Validasi</a>
            </div>
          </div>
        </div>
    </div>
          ...
          <div class="card mb-4">
            <div class="card-body pt-3 p-3">
                ...
                <form method="POST" action="{{ url('validasi/' . $kriteria->kriteria_id . '/komentar')}}" id="form-komentar" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="redirect_to" value="{{ url('validasi/kpskajur/') }}">
                    
                    <div class="card-footer">
                        <a href="{{ url('validasi/kpskajur/') }}" class="btn btn-warning">Kembali</a>
