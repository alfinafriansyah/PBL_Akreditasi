          ...
          <div class="card">
            ...
            <div class="card-body pt-1 p-3">
                ...
                @if ($kriteria->status_id == null)
                    <div class="row">
                        <div class="col">
                            <a href="{{ url('kriteria7/create')}}" class="btn btn-primary float-end me-3">Tambah</a>
                        </div>
                    </div>
                @endif
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="table_kriteria7">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Kode</th>
...
$(document).ready(function() {
    dataKriteria7 = $('#table_kriteria7').DataTable({
        serverSide: true,
        processing: true, 
        ajax: {
